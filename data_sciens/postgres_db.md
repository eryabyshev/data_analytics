...
Загружать данные в Postgres можно из CSV файлов, ниже пример который загружает данные из table.csv:
...
<pre>
psql -c "\\copy ratings FROM '/data/ratings.table.csv' DELIMITER ',' CSV HEADER"
</pre>

Примечание: перед тем, как загружать данные, нужно очень внимательно изучить table.csv файл - чтобы точно узнать типы данных и их размерности
...
<pre>
\copy (SELECT * FROM ratings LIMIT 100) TO 'ratings_file.table.csv' WITH CSV HEADER DELIMETER as ',';
</pre>
